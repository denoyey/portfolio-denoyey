...
const SidebarItem = ({ to, label, lineNum, isCollapsed, onClick }) => (
  <NavLink
    ...
    onClick={onClick}
    className={({ isActive }) =>
      `relative flex items-center gap-3 px-3 py-2.5 mx-2 rounded-md transition-colors duration-200 group font-mono ${isActive
  ...
  return (
    <div className={`flex items-center justify-center min-h-screen ${isMobile ? 'p-0' : 'p-4'}`}>
      <motion.div
        ...
        className={`flex flex-col md:flex-row w-full bg-[#1e293b] overflow-hidden font-sans ${isMobile
      ...
      >
              ...
              {isSidebarOpen && (
                ...
                >
                  ...
                  <div className="flex flex-col gap-1 pb-4 px-2">
                    ...
                    <SidebarItem to="/achievement" label="Achievements" lineNum="03" isCollapsed={false} onClick={() => setIsSidebarOpen(false)} />
        ...
        {!isMobile && (
          ...
          >
            ...
            <nav className={`flex-1 px-2 space-y-0.5 pt-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] ${isSidebarOpen ? 'overflow-y-auto' : 'overflow-visible'}`}>
              ...
              <SidebarItem to="/achievement" label="Achievements" lineNum="03" isCollapsed={!isSidebarOpen} />
        ...
        <main className="flex-1 relative overflow-hidden flex flex-col bg-[#1e293b]">
          <div ref={scrollRef} className={`flex-1 overflow-y-auto p-2 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] ${isMobile ? 'pb-15' : ''}`}>
